...
export default function DocReviewCard({ name, status, onClick }) {
  ...
  return (
    <div onClick={onClick} className="border border-slate-200 rounded-xl cursor-pointer transition hover:-translate-y-1 hover:shadow-lg hover:border-indigo-600 overflow-hidden">
