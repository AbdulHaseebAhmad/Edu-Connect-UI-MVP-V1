...
export function UniGptPage() {
  ...
  return (
    <div className="fade-in">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="bg-[#1e293b] p-6 rounded-2xl shadow-xl shadow-slate-300 text-white group cursor-pointer hover:bg-[#0f172a] transition duration-500 relative overflow-hidden border border-slate-700">

  {/* Coming Soon ribbon */}
  <div className="absolute top-3 right-3 bg-amber-400 text-amber-950 text-[10px] font-bold px-3 py-1 rounded-full shadow-lg z-20">
    Coming Soon
  </div>
  ...
  <span className="text-xs font-bold bg-white/10 px-3 py-1.5 rounded-lg group-hover:bg-purple-600 transition relative z-10 inline-block opacity-60 cursor-not-allowed">
    Start Assessment →
  </span>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden relative min-h-[500px]">
          ...
          {isLoading && (
            <div className="absolute inset-0 bg-white z-20 flex flex-col items-center justify-center">
              ...
              <p className="text-slate-500 mt-2">
                Cross-referencing 500+ programs against your profile
              </p>
            </div>
          )}
          ...
          <div
            className={`p-8 space-y-6 transition-opacity duration-300 ${currentStep === 1 ? "block" : "hidden"}`}
          >
            <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
              <div className="w-8 h-8 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center text-sm font-bold">
                1
              </div>
          ...
          {/* STEP 2: Financial */}
          <div
            className={`p-8 space-y-6 transition-opacity duration-300 ${currentStep === 2 ? "block" : "hidden"}`}
          >
            <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
              <div className="w-8 h-8 bg-orange-100 text-orange-600 rounded-xl flex items-center justify-center text-sm font-bold">
                2
              </div>
              Financial Logistics
            </h3>
          ...
          {/* STEP 3: Ready */}
          <div
            className={`p-8 flex flex-col items-center justify-center text-center pt-20 transition-opacity duration-300 ${currentStep === 3 ? "block" : "hidden"}`}
          >
            ...
            <p className="text-slate-500 mb-8 max-w-md mx-auto leading-relaxed">
              UniGPT will now cross-reference your academic profile, career
              goals, and budget against admission criteria from 500+ programs
              worldwide.
            </p>
            <button
              onClick={runAnalysis}
          ...
          {/* RESULTS SCREEN */}
          <div
            className={`transition-opacity duration-700 ${showResults ? "block" : "hidden"}`}
          >
              ...
              <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-10 rounded-3xl shadow-2xl text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-300 text-lg max-w-md mx-auto leading-relaxed">
                    Exceptional fit for top-tier Computer Science programs.
                    Multiple scholarship opportunities identified.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg text-slate-900 group-hover:text-blue-600 transition">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg text-slate-900 group-hover:text-purple-600 transition">
                        MIT
                      </h4>
                      <p className="text-sm text-slate-500">
